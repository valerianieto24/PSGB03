...
<html dir="ltr" lang="es" class="home_page home_page_design s_layout2 isFreePackage  in-management js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths parallax-active page-loaded"><head>  
   ...
   <meta name="theme-color" content="#1abc9c"> 
    ...
    <title class="s123-js-pjax">Tecnology Scanning - Bienvenido a Tecnology Scanning</title> 
 ...
 <a href="cerrarsesion.php" style="te">cerrar sesion</a>
        ...
        <span class="txt-container">¿Quiénes somos? </span>
            ...
            <div class="navbar-header"> 
            <a class="navbar-brand page-scroll logo_name  weight700 " href="https://app.site123.com/?w=3813408#page-top"> 
            <span class="website-name">Tecnology Scanning</span >
            </a> </div> 
            ...
            <h1 id="home_siteSlogan" class=" weight400  shadow1  0 10">Bienvenido a Tecnology Scanning</h1>
            ...
            <br><br>¡Consultoría Tecnológica Technology Scanning !<br>&nbsp;
            <br>Verde Es un color relajante y refrescante que induce a quién lo contempla sensaciones de serenidad y armonía.&nbsp;<br>Verde Este color representa la tranquilidad, armonía, crecimiento. Ya que cada día impulsaremos el crecimiento de la consultoría. &nbsp;
            <br>Negro Este color representa el poder, valentía, elegancia, sobriedad, estatus de alta calidad. Ya que transmitiremos una enseñanza con sinceridad ante los espectadores.&nbsp;<br> Negro Representa poder, valentía, elegancia, sobriedad, estatus de alta calidad y un toque de misterio. Transmitiendo un mensaje de seriedad ante los espectadores.&nbsp;
            <br>Azul Representa seguridad, confiabilidad, responsabilidad, serenidad. Transmitir un mensaje de confianza, seguridad y madurez ante los espectadores.&nbsp;
            <br>Rojo Por extensión, también se encuentra vinculado al calor, al Sol, a la guerra y a la violencia (en la que es habitual la sangre). &nbsp;
            <br>Amarillo Por un lado se le asocia con la felicidad, la alegría y el optimismo y por el otro, con los celos, la envidia, el egoísmo y algunas enfermedades.&nbsp;

            <br><br>
            </div> </div> 
            <div class="col-xs-12 col-md-6"> 
            <div class="separateImages text-center">
            <img src="img/logo.png" style="max-height:400px;max-width:80%;display:inline-block;" alt="¿Quiénes somos? ">
            ...
            <h4>
            <img src="img/img4.jpeg" style="width:50%; height:50%;">
            <br>
            <strong>Fatima Flores Garduño</strong>
            </h4>
            <p>Documentista</p>
            </div></div>
            <div class="col-md-3 col-sm-6 col-centered">
            <div class="service-item">
            <h4>
            <img src="img/img2.jpeg" style="width:50%; height:50%;">
            <br>
            <strong>Vannesa Velazquez Diaz</strong>
            </h4>
            <p>Programadora</p>
            </div></div>
            <br>
            ...
            <div class="service-item">
            <h4>
            <img src="img/img3.jpeg" style="width:50%; height:50%;"> 
            <br>  
            <strong>Emiliano Erinque Rangel Francisco</strong>
            </h4>
            <p>Diseñador</p>
            </div></div> 
              </div> 
            ...
            </i>Tecnology_Scanning@gmail.com</a>
            </li> </ul> </div> 
            ...
            <div> 
            <span class="footer_name website-name-preview-helper">Tecnology Scanning</span> 
            </div>                             
            ...
            <span dir="ltr">Tecnology_Scanning@gmail.com</span>
            </a></li> </ul> </div> </div></div> 
